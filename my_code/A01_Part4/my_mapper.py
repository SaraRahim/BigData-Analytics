...
def my_map(my_input_stream, my_output_stream, my_mapper_input_parameters):
    ...
    # using a dictionary to store trip counts per station start and stop trips
    my_stations_dict = {}
    ...
    for line in my_input_stream:
        ...
        if record:
            # extracting start and stop station names
            ...
            for index in range(2):
                ...
                my_stations_dict[station_name][index] += 1

    # writing results to the output stream
    for station in my_stations_dict:
        counts = my_stations_dict[station]
        my_str = station + "\t(" + str(counts[0]) + ", " + str(counts[1]) + ")\n"
